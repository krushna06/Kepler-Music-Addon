module.exports = {
  ...
  links: {
    inviteURL:
      ...
      `https://discord.com/api/oauth2/authorize?client_id=1047853733431738418&permissions=8&scope=bot%20applications.commands`,
    DiscordServer: process.env.DiscordServer || `https://discord.gg/hwJR8nft2K`,
    VoteURL: process.env.VoteURL || `https://discord.gg/hwJR8nft2K`,
    Website: `https://dornox.vercel.app/`,
  },
  options: {
    embedFooter: true,
    nowplayingMsg: true,
